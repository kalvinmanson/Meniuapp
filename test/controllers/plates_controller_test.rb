...
class PlatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plate" do
    assert_difference('Plate.count') do
      post plates_url, params: { plate: { active: @plate.active, content: @plate.content, favored: @plate.favored, name: @plate.name, place_id: @plate.place_id, price: @plate.price, slug: @plate.slug, tags: @plate.tags } }
    end
  ...
  test "should update plate" do
    patch plate_url(@plate), params: { plate: { active: @plate.active, content: @plate.content, favored: @plate.favored, name: @plate.name, place_id: @plate.place_id, price: @plate.price, slug: @plate.slug, tags: @plate.tags } }
