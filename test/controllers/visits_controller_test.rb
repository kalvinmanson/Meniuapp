...
class VisitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visit" do
    assert_difference('Visit.count') do
      post visits_url, params: { visit: { plate_id: @visit.plate_id, user_id: @visit.user_id } }
    end
  ...
  test "should update visit" do
    patch visit_url(@visit), params: { visit: { plate_id: @visit.plate_id, user_id: @visit.user_id } }
