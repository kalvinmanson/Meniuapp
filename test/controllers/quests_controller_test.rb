...
class QuestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quest" do
    assert_difference('Quest.count') do
      post quests_url, params: { quest: { lat: @quest.lat, lng: @quest.lng, quest: @quest.quest, user_id: @quest.user_id, visited_place: @quest.visited_place, visited_plate: @quest.visited_plate } }
    end
  ...
  test "should update quest" do
    patch quest_url(@quest), params: { quest: { lat: @quest.lat, lng: @quest.lng, quest: @quest.quest, user_id: @quest.user_id, visited_place: @quest.visited_place, visited_plate: @quest.visited_plate } }
